  ...
  return (
    <>
      ...
      <div className="mt-10 flex gap-8 flex-col md:flex-row md:items-end">
        <div className="w-48 h-48 md:w-60 md:h-60 lg:w-72 lg:h-72 shrink-0">
          <img
            src={albumData.cover}
            alt={albumData.title}
            className="w-full h-full object-cover rounded-md shadow-2xl transition-transform duration-300 hover:scale-105 cursor-pointer"
          />
        </div>
